  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-gray-50">
		...
		<img src={`${import.meta.env.BASE_URL}SanvalEbert.jpg`} alt="Foto do Doutorando" className="w-full h-full object-cover" />
              </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-8 rounded-lg">
            <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
              <div className="w-32 h-32 rounded-full overflow-hidden flex-shrink-0">
		<img src={`${import.meta.env.BASE_URL}HugoSaba.jpg`} alt="Prof. Dr. Hugo Saba Pereira Cardoso" className="w-full h-full object-cover" />
              </div>
              <div className="flex-1 text-center md:text-left">
